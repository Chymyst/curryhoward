...
// res1: User1[Int, String] = User1(name = 123, id = "id:12300")
```
...
// user: User2[Int] = User2(name = "abc", id = 123) // User2[Int]
...
// res6: User1[Int, String] = User1(name = 123, id = "id:12300")
```
...
// error: type <c>Int ⇒ 0 cannot be implemented
// val x: Int = ofType(123)
//              ^^^^^^^^^^^
```
...
// error: repl.MdocSession.App.User1[Int,String] does not take parameters
// ofType[User1[Int, String]](123, (n: Int) ⇒ "id:" + (n * 100).toString)
// ^
// error: type (<c>String ⇒ <c>Int) ⇒ (<c>Int ⇒ <c>Int) ⇒ (<c>Double ⇒ <c>Int) ⇒ User2[<c>Int] ⇒ A ⇒ A ⇒ (A ⇒ B) ⇒ B can be implemented in 2 inequivalent ways:
//  a ⇒ b ⇒ c ⇒ d ⇒ e ⇒ f ⇒ g ⇒ g f [score: (5,0,0,0,0)];
//  a ⇒ b ⇒ c ⇒ d ⇒ e ⇒ f ⇒ g ⇒ g e [score: (5,0,0,0,0)].
// def ff[A, B]: A ⇒ A ⇒ (A ⇒ B) ⇒ B = implement
//                                     ^^^^^^^^^
```
...
// fs: Seq[Function1Lambda[Int, Int => Int]] = List(<function1>, <function1>)
fs.map(f ⇒ f(1)(2))
// res10: Seq[Int] = List(2, 1)
```
...
```scala
fs(0).lambdaTerm
// res11: TermExpr = CurriedE(
//   heads = List(
//     VarE(name = "a", t = BasicT(name = "Int")),
//     VarE(name = "b", t = BasicT(name = "Int"))
//   ),
//   body = VarE(name = "b", t = BasicT(name = "Int"))
// )
fs(1).lambdaTerm
// res12: TermExpr = CurriedE(
//   heads = List(
//     VarE(name = "a", t = BasicT(name = "Int")),
//     VarE(name = "b", t = BasicT(name = "Int"))
//   ),
//   body = VarE(name = "a", t = BasicT(name = "Int"))
// )
```
...
// res14: String = "\\((a:<c>Int) \u21d2 (b:<c>Int) \u21d2 b)"
```
...
```scala
val x = freshVar[Int]
// x: VarE = VarE(name = "x$34", t = BasicT(name = "Int"))
val y = freshVar[Int]
// y: VarE = VarE(name = "y$36", t = BasicT(name = "Int"))
```
...
//         body = VarE(name = "b", t = BasicT(name = "Int"))
//       ),
//       arg = VarE(name = "x$34", t = BasicT(name = "Int"))
//     ),
//     arg = VarE(name = "y$36", t = BasicT(name = "Int"))
//   ),
//   AppE(
//     head = AppE(
//       head = CurriedE(
...
// res16: Seq[TermExpr] = List(
//   VarE(name = "y$36", t = BasicT(name = "Int")),
//   VarE(name = "x$34", t = BasicT(name = "Int"))
// )
```
...
// goodF: Function1Lambda[Int, Int => Int] = <function1>
```
...
// fmapT: TermExpr = CurriedE(
//   heads = List(
//     VarE(name = "a", t = TP(name = "A") #-> TP(name = "B")),
//     VarE(
//       name = "b",
//       t = DisjunctT(
//         constructor = "Either",
//         typeParams = List(BasicT(name = "Int"), TP(name = "A")),
//         terms = List(
//           NamedConjunctT(
//             constructor = "Left",
//             typeParams = List(BasicT(name = "Int"), TP(name = "A")),
//             accessors = List("value"),
//             wrapped = List(BasicT(name = "Int"))
//           ),
//           NamedConjunctT(
//             constructor = "Right",
//             typeParams = List(BasicT(name = "Int"), TP(name = "A")),
//             accessors = List("value"),
//             wrapped = List(TP(name = "A"))
//           )
//         )
//       )
//     )
...
//     cases = List(
//       CurriedE(
// ... // No need to specify type parameters here.
fmapT.prettyPrint
// res19: String = "a \u21d2 b \u21d2 b match { c \u21d2 (Left(c.value) + 0); d \u21d2 (0 + Right(a d.value)) }"
fmapT.t.prettyPrint // The type of fmap.
// res20: String = "(A \u21d2 B) \u21d2 Either[<c>Int,A] \u21d2 Either[<c>Int,B]"
```
...
def a[A] = freshVar[A]
val identA = a =>: a
// identA: TermExpr = CurriedE(
//   heads = List(VarE(name = "a$1", t = TP(name = "A"))),
//   body = VarE(name = "a$1", t = TP(name = "A"))
// )
```
...
```scala
val b = freshVar[Int]
// b: VarE = VarE(name = "b$55", t = BasicT(name = "Int"))
a =>: b =>: a
// res21: TermExpr = CurriedE(
//   heads = List(VarE(name = "a$1", t = TP(name = "A"))),
//   body = CurriedE(
//     heads = List(VarE(name = "b$55", t = BasicT(name = "Int"))),
//     body = VarE(name = "a$1", t = TP(name = "A"))
//   )
// )
```
...
//   head = CurriedE(
//     heads = List(
//       VarE(name = "a", t = TP(name = "A") #-> TP(name = "A")),
//       VarE(
//         name = "b",
//         t = DisjunctT(
//           constructor = "Either",
...
// ...
f2.t.prettyPrint
// res23: String = "Either[<c>Int,A] \u21d2 Either[<c>Int,A]"
```
...
// pureT: TermExpr = CurriedE(
//   heads = List(VarE(name = "a", t = TP(name = "A"))),
//   body = DisjunctE(
//     index = 1,
//     total = 2,
//     term = NamedConjunctE(
//       terms = List(VarE(name = "a", t = TP(name = "A"))),
//       t = NamedConjunctT(
//         constructor = "Right",
//         typeParams = List(BasicT(name = "Int"), TP(name = "A")),
//         accessors = List("value"),
...
// leftSide: TermExpr = CurriedE(
//   heads = List(VarE(name = "x2227", t = TP(name = "A"))),
//   body = AppE(
//     head = CurriedE(
//       heads = List(VarE(name = "a", t = TP(name = "B"))),
//       body = DisjunctE(
//         index = 1,
//         total = 2,
//         term = NamedConjunctE(
//           terms = List(VarE(name = "a", t = TP(name = "B"))),
//           t = NamedConjunctT(
//             constructor = "Right",
//             typeParams = List(BasicT(name = "Int"), TP(name = "B")),
//             accessors = List("value"),
//             wrapped = List(TP(name = "B"))
//           )
//         ),
//         t = DisjunctT(
//           constructor = "Either",
...
//     ),
//     arg = AppE(
//       head = VarE(name = "f$1", t = TP(name = "A") #-> TP(name = "B")),
//       arg = VarE(name = "x2227", t = TP(name = "A"))
//     )
//   )
// )
val rightSide = pureT :@@ (fmapT :@ f)
// rightSide: TermExpr = CurriedE(
//   heads = List(VarE(name = "x2228", t = TP(name = "A"))),
//   body = AppE(
//     head = AppE(
//       head = CurriedE(
//         heads = List(
...
//         constructor = "User",
//         typeParams = List(),
//         accessors = List("fullName", "id"),
//         wrapped = List(BasicT(name = "String"), BasicT(name = "Long"))
//       )
//     ),
//     terms = List(
//       NamedConjunctT(
...
// ol: DisjunctT = DisjunctT(
//   constructor = "Option",
//   typeParams = List(BasicT(name = "Long")),
//   terms = List(
//     NamedConjunctT(
//       constructor = "None",
//       typeParams = List(),
...
//       typeParams = List(BasicT(name = "Long")),
//       accessors = List("value"),
//       wrapped = List(BasicT(name = "Long"))
//     )
//   )
// )
val case1 = n =>: ol(n.t())
// case1: TermExpr = CurriedE(
//   heads = List(
//     VarE(
//       name = "n$69",
//       t = NamedConjunctT(
...
// sl: NamedConjunctT = NamedConjunctT(
//   constructor = "Some",
//   typeParams = List(BasicT(name = "Long")),
//   accessors = List("value"),
//   wrapped = List(BasicT(name = "Long"))
...
// ...
getId.prettyPrint
// res27: String = "ou$67 \u21d2 ou$67 match { n$69 \u21d2 (None() + 0); su$71 \u21d2 (0 + Some(su$71.value.id)) }"
```
...
// dString: VarE = VarE(name = "dString$79", t = BasicT(name = "String"))
val dLong = freshVar[Long]
// dLong: VarE = VarE(name = "dLong$81", t = BasicT(name = "Long"))
val u = freshVar[User]
// u: VarE = VarE(
//   name = "u$83",
//   t = NamedConjunctT(
...
//       NamedConjunctE(
//         terms = ArraySeq(
//           VarE(name = "dString$79", t = BasicT(name = "String")),
//           VarE(name = "dLong$81", t = BasicT(name = "Long"))
//         ),
//         t = NamedConjunctT(
//           constructor = "User",
//           typeParams = List(),
...
// result1: TermExpr = DisjunctE(
//   index = 1,
//   total = 2,
//   term = NamedConjunctE(
//     terms = ArraySeq(VarE(name = "dLong$81", t = BasicT(name = "Long"))),
//     t = NamedConjunctT(
//       constructor = "Some",
//       typeParams = List(BasicT(name = "Long")),
//       accessors = List("value"),
...
// getIdAutoTerm: TermExpr = CurriedE(
//   heads = List(
//     VarE(
//       name = "a",
//       t = DisjunctT(
...
// res28: String = "a \u21d2 a match { b \u21d2 (None() + 0); c \u21d2 (0 + Some(c.value.id)) }"
getId.prettyPrint
// res29: String = "ou$67 \u21d2 ou$67 match { n$69 \u21d2 (None() + 0); su$71 \u21d2 (0 + Some(su$71.value.id)) }"
``` 
